...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Berta_Kessler50',
      password: 'MV7zy5K_S429nYf',
      email: 'Raphaelle_Spencer@hotmail.com',
      name: 'Jody Okuneva',
      userType: 794,
      mobileNo: '(901) 132-3580',
      resetPasswordLink: {},
      loginRetryLimit: 374,
      loginReactiveTime: '2023-10-11T12:07:48.197Z',
      id: '64719c55317b3b535877c918'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Zackery.Brown7',
        'password':'u6pIDAc51cophaB',
        'email':'Xavier73@gmail.com',
        'name':'Brenda Smith',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(266) 205-8978',
